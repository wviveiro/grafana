...
import (
	...
	"github.com/wviveiro/grafana/pkg/cmd/grafana-cli/commands"
	"github.com/wviveiro/grafana/pkg/cmd/grafana-cli/logger"
	"github.com/wviveiro/grafana/pkg/cmd/grafana-cli/services"
	"github.com/wviveiro/grafana/pkg/cmd/grafana-cli/utils"
)
...
func main() {
	...
	app.Email = "https://github.com/wviveiro/grafana"
	app.Version = version
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:   "pluginsDir",
