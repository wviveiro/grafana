...
- **Graph**: Support for shared tooltip on all graphs as you hover over one graph. [#1578](https://github.com/wviveiro/grafana/pull/1578), [#6274](https://github.com/wviveiro/grafana/pull/6274)
