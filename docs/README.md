...
```
git clone https://github.com/wviveiro/grafana.org
cd grafana.org
make docs-build
```
...
```
cd ..
git clone https://github.com/wviveiro/grafana
```
...
All markdown files are located in this repo (main grafana repo). But all images are added to the https://github.com/wviveiro/grafana.org repo. So the process of adding images is a bit complicated. 

First you need create a feature (PR) branch of https://github.com/wviveiro/grafana.org so you can make change. Then add the image to the `/static/img/docs` directory. Then make a commit that adds the image. 
